...
# d) Histograma + QQ
hist(residuos, breaks = 70, main = "Distribución de residuos", xlab = "Residuo")
...
# d) Histograma + QQ
hist(residuos$res, breaks = 70, main = "Distribución de residuos", xlab = "Residuo")
