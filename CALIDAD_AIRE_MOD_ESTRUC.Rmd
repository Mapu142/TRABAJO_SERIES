...
uego de aplicar la transformación logarítmica a la serie de PM2.5, el test de Dickey–Fuller Aumentado (ADF) arrojó un estadístico de -7.701 con un p-valor < 0.01, lo que indicaría estacionariedad a un nivel de significancia del 5%.
